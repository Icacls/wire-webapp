...
class z.media.MediaDevicesHandler
  ...
  constructor: (@media_repository) ->
    ...
    @stream_handler = @media_repository.stream_handler
  ...
  _subscribe_to_observables: =>
    ...
    @current_device_id.audio_input.subscribe (media_device_id) =>
      ...
      if media_device_id and @stream_handler.local_media_streams.audio()
        @stream_handler.replace_input_source z.media.MediaType.AUDIO
    ...
    @current_device_id.screen_input.subscribe (media_device_id) =>
      if media_device_id and @stream_handler.local_media_streams.video() and @stream_handler.local_media_type() is z.media.MediaType.SCREEN
        @stream_handler.replace_input_source z.media.MediaType.SCREEN
    ...
    @current_device_id.video_input.subscribe (media_device_id) =>
      ...
      if media_device_id and @stream_handler.local_media_streams.video() and @stream_handler.local_media_type() is z.media.MediaType.VIDEO
        @stream_handler.replace_input_source z.media.MediaType.VIDEO
